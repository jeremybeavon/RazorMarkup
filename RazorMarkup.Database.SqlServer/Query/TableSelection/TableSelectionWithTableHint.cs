...
{
    internal class TableSelectionWithTableHint<TEndType> :
        ...
        ITableSelectionWithTableHint<TEndType>
    {
        ...
        private TableSelectionWithTableHint(FromClauseBuilder statement, TableSelectionFactory<TEndType> factory)
            : base(
                  statement,
