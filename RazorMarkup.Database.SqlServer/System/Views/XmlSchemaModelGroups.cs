...
namespace RazorMarkup.Database.SqlServer.System.Views
{
    ...
    {
        public static readonly ViewName ViewName = new("sys.xml_schema_model_groups");

        public static readonly Column<SqlInt> BaseXmlComponentId = new("base_xml_component_id");

        public static readonly Column<SqlChar> Compositor = new("compositor");

        public static readonly Column<SqlNVarchar> CompositorDesc = new("compositor_desc");
