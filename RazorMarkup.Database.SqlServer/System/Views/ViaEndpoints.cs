...
namespace RazorMarkup.Database.SqlServer.System.Views
{
    ...
    {
        public static readonly ViewName ViewName = new ViewName("sys.via_endpoints");
        
        public static readonly Column<SqlNVarchar> Discriminator = new Column<SqlNVarchar>("discriminator");
