...
namespace RazorMarkup.Database.SqlServer.System.Views
{
    ...
    {
        public static readonly ViewName ViewName = new("sys.xml_indexes");
        ...
        public static readonly Column<SqlChar> SecondaryType = new("secondary_type");

        public static readonly Column<SqlNVarchar> SecondaryTypeDesc = new("secondary_type_desc");

        public static readonly Column<SqlTinyInt> Type = new("type");

        public static readonly Column<SqlNVarchar> TypeDesc = new("type_desc");

        public static readonly Column<SqlInt> UsingXmlIndexId = new("using_xml_index_id");

        public static readonly Column<SqlTinyInt> XmlIndexType = new("xml_index_type");

        public static readonly Column<SqlNVarchar> XmlIndexTypeDescription = new("xml_index_type_description");
    }
}
