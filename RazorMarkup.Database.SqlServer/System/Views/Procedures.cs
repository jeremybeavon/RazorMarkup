...
namespace RazorMarkup.Database.SqlServer.System.Views
{
    ...
    {
        public static readonly ViewName ViewName = new("sys.procedures");

        public static readonly Column<SqlDateTime> CreateDate = new("create_date");

        public static readonly Column<SqlBit> IsAutoExecuted = new("is_auto_executed");

        public static readonly Column<SqlBit> IsExecutionReplicated = new("is_execution_replicated");
        ...
        public static readonly Column<SqlBit> IsReplSerializableOnly = new("is_repl_serializable_only");
        ...
        public static readonly Column<SqlBit> SkipsReplConstraints = new("skips_repl_constraints");
