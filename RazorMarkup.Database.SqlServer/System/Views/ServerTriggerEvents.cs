...
namespace RazorMarkup.Database.SqlServer.System.Views
{
    ...
    {
        public static readonly ViewName ViewName = new("sys.server_trigger_events");
        ...
        public static readonly Column<SqlBit> IsFirst = new("is_first");

        public static readonly Column<SqlBit> IsLast = new("is_last");
