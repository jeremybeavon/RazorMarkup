...
namespace RazorMarkup.Database.SqlServer.System.Views
{
    ...
    {
        public static readonly ViewName ViewName = new ViewName("sys.tcp_endpoints");
        
        public static readonly Column<SqlInt> EndpointId = new Column<SqlInt>("endpoint_id");
        
        public static readonly Column<SqlVarchar> IpAddress = new Column<SqlVarchar>("ip_address");
        
        public static readonly Column<SqlBit> IsAdminEndpoint = new Column<SqlBit>("is_admin_endpoint");
        
        public static readonly Column<SqlBit> IsDynamicPort = new Column<SqlBit>("is_dynamic_port");
