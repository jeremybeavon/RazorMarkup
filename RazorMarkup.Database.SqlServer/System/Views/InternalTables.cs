...
namespace RazorMarkup.Database.SqlServer.System.Views
{
    ...
    {
        public static readonly ViewName ViewName = new ViewName("sys.internal_tables");
        
        public static readonly Column<SqlDateTime> CreateDate = new Column<SqlDateTime>("create_date");
        
        public static readonly Column<SqlInt> FilestreamDataSpaceId = new Column<SqlInt>("filestream_data_space_id");
        
        public static readonly Column<SqlTinyInt> InternalType = new Column<SqlTinyInt>("internal_type");
        
        public static readonly Column<SqlNVarchar> InternalTypeDesc = new Column<SqlNVarchar>("internal_type_desc");
        ...
        public static readonly Column<SqlInt> LobDataSpaceId = new Column<SqlInt>("lob_data_space_id");
        ...
        public static readonly Column<SqlInt> ParentMinorId = new Column<SqlInt>("parent_minor_id");
