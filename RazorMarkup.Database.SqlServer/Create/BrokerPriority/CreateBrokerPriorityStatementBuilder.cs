...
{
    internal sealed class CreateBrokerPriorityStatementBuilder : AbstractStatementBuilder
    {
        public CreateBrokerPriorityStatementBuilder(ConversationPriorityName name)
        ...
        {
            sqlBuilder.Append("CREATE BROKER PRIORITY ");
