...
{
    public interface IInputDateTimeLocalElement : IInputElement<IInputDateTimeLocalElement>
    {
        ...
        IInputDateTimeLocalElement WithAutocompleteOn();
        ...
        [BrowserCompatibility(BrowserType.Safari, IsSupported = true)]
        [BrowserCompatibility(BrowserType.Opera, IsSupported = true)]
        IInputDateTimeLocalElement WithAutocompleteOff();

        IInputDateTimeLocalElement WithDisabled();
        ...
        [BrowserCompatibility(BrowserType.Safari, IsSupported = true)]
        [BrowserCompatibility(BrowserType.Opera, IsSupported = true)]
        IInputDateTimeLocalElement WithMax(DateTime max);
        ...
        [BrowserCompatibility(BrowserType.Safari, IsSupported = true)]
        [BrowserCompatibility(BrowserType.Opera, IsSupported = true)]
        IInputDateTimeLocalElement WithMin(DateTime min);
        ...
        IInputDateTimeLocalElement WithRequired();

        IInputDateTimeLocalElement WithValue(DateTime value);
    }
}
