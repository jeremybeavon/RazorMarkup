...
{
    public static class InputCheckboxElementExtensions
    {
        ...
        public static IInputCheckboxElement WithRequired(this IInputCheckboxElement checkbox)
        {
            return checkbox.AddAttribute("required", "required");
        }
    }
}
